...
CREATE TABLE `keyword` (
  `kw_id` varchar(50) NOT NULL,
  `kw_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `book_keyword`
  ...
  ADD CONSTRAINT `fk_keyword_id` FOREIGN KEY (`keyword_id`) REFERENCES `keyword` (`kw_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `keyword_id` FOREIGN KEY (`keyword_id`) REFERENCES `keyword` (`kw_id`) ON UPDATE CASCADE;
