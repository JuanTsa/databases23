...
Code_date.hour.sql: the code for the sql database (24.05.21.42 is the code written until 24/05/2023, at 21:42 (so you can check if you have the latest update)).
Relations_date.hour.png: the relational model
