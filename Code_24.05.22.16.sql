...
ALTER TABLE `operator`
  ADD PRIMARY KEY (`user_id`),
  ADD UNIQUE KEY `operator_name_2` (`operator_name`),
...
ALTER TABLE `operator`
  ...
  ADD CONSTRAINT `operator_ibfk_2` FOREIGN KEY (`operator_name`) REFERENCES `school_unit` (`operator_name`) ON UPDATE CASCADE;
