...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2023 at 01:50 PM
...
INSERT INTO `book` (`book_id`, `isbn`, `title`, `publisher`, `pages`, `summary`, `available_copies`, `cover`, `language`, `inventory`, `total_borrowings`) VALUES
(1, '415221916-5', 'American Pimp', 'Juan', '69', 'idkshitwhatever', '8', 'red', 'english', '12', '2'),
(2, '415221916-8', 'American Pimp', 'Juan', '69', 'idkshitwhatever', '8', 'red', 'english', '12', '2');
...
--
ALTER TABLE `school_unit`
  ADD CONSTRAINT `fk_operator_id` FOREIGN KEY (`operator_id`) REFERENCES `operator` (`user_id`) ON UPDATE CASCADE;
